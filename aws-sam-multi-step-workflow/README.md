...
```bash
aws-sam-multi-step-workflow$ sam build --use-container
```
...
```bash
aws-sam-multi-step-workflow$ sam logs -n StockCheckerFunction --stack-name aws-sam-multi-step-workflow --tail
```
...
```bash
aws-sam-multi-step-workflow$ pip install -r tests/requirements.txt --user
# unit test
aws-sam-multi-step-workflow$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
aws-sam-multi-step-workflow$ AWS_SAM_STACK_NAME=<stack-name> python -m pytest tests/integration -v
```
...
```bash
aws cloudformation delete-stack --stack-name aws-sam-multi-step-workflow
```
